...
A{"DarkmoonFaireIsland", 6020, 0.525, 0.561, criterion=18234} -- Cannon Blast
A{"DarkmoonFaireIsland", 6020, 0.515, 0.778, criterion=18235} -- Ring Toss
A{"DarkmoonFaireIsland", 6020, 0.506, 0.650, criterion=18237} -- Tonk Battle
A{"DarkmoonFaireIsland", 6020, 0.534, 0.545, criterion=18238} -- Whack-A-Gnoll
A{"DarkmoonFaireIsland", 6020, 0.494, 0.607, criterion=18236} -- Shooting Gallery

-- World Events/Darkmoon Faire: Blastenheimer Bullseye
A{"DarkmoonFaireIsland", 6021, 0.525, 0.561}

-- World Events/Darkmoon Faire: Quick Shot
A{"DarkmoonFaireIsland", 6022, 0.494, 0.607}

-- World Events/Darkmoon Faire: Darkmoon Duelist
A{"DarkmoonFaireIsland", 6023, 0.474, 0.789}
...
A{"DarkmoonFaireIsland", 6026, 0.528, 0.680, criterion=6903} -- Pickled Kodo Foot
A{"DarkmoonFaireIsland", 6026, 0.504, 0.696, criterion=4665} -- Cheap Beer
A{"DarkmoonFaireIsland", 6026, 0.504, 0.696, criterion=4661} -- Bottled Winterspring Water
A{"DarkmoonFaireIsland", 6026, 0.528, 0.680, criterion=6567} -- Deep Fried Candybar
A{"DarkmoonFaireIsland", 6026, 0.504, 0.696, criterion=4687} -- Fizzy Faire Drink
A{"DarkmoonFaireIsland", 6026, 0.504, 0.696, criterion=9015} -- Iced Berry Slush
A{"DarkmoonFaireIsland", 6026, 0.528, 0.680, criterion=6915} -- Red Hot Wings
A{"DarkmoonFaireIsland", 6026, 0.528, 0.680, criterion=7017} -- Spiced Beef Jerky
A{"DarkmoonFaireIsland", 6026, 0.528, 0.680, criterion=8030} -- Forest Strider Drumstick
A{"DarkmoonFaireIsland", 6026, 0.528, 0.680, criterion=6552} -- Crunchy Frog
A{"DarkmoonFaireIsland", 6026, 0.504, 0.696, criterion=18610} -- Sasparilla Sinker
A{"DarkmoonFaireIsland", 6026, 0.528, 0.680, criterion=18596} -- Salty Sea Dog
A{"DarkmoonFaireIsland", 6026, 0.504, 0.696, criterion=9016} -- Fizzy Faire Drink "Classic"
A{"DarkmoonFaireIsland", 6026, 0.504, 0.696, criterion=4678} -- Darkmoon Special Reserve
A{"DarkmoonFaireIsland", 6026, 0.528, 0.680, criterion=7957} -- Funnel Cake
A{"DarkmoonFaireIsland", 6026, 0.528, 0.680, criterion=18252} -- Corn-Breaded Sausage
A{"DarkmoonFaireIsland", 6026, 0.504, 0.696, criterion=18609} -- Fresh-Squeezed Limeade

-- World Events/Darkmoon Faire: Faire Favors
A{"DarkmoonFaireIsland", 6032}

-- World Events/Darkmoon Faire: That Rabbit's Dynamite!
A{"DarkmoonFaireIsland", 6332, 0.776, 0.808}

-- World Events/Darkmoon Faire: Flying High
A{"DarkmoonFaireIsland", 9250, 0.484, 0.714}

-- World Events/Darkmoon Faire: Ringmaster
A{"DarkmoonFaireIsland", 9251, 0.484, 0.714}

-- World Events/Darkmoon Faire: Brood of Alysrazor
A{"DarkmoonFaireIsland", 9252, 0.484, 0.714}

-- World Events/Darkmoon Faire: Darkmoon Race Enthusiast
A{"DarkmoonFaireIsland", 9755, 0.490, 0.881}

-- World Events/Darkmoon Faire: Darkmoon Racer Novice
A{"DarkmoonFaireIsland", 9756, 0.490, 0.881}

-- World Events/Darkmoon Faire: Darkmoon Racer Jockey
A{"DarkmoonFaireIsland", 9759, 0.490, 0.881}

-- World Events/Darkmoon Faire: Darkmoon Racer Leadfoot
A{"DarkmoonFaireIsland", 9760, 0.490, 0.881}

-- World Events/Darkmoon Faire: Darkmoon Racer Roadhog
A{"DarkmoonFaireIsland", 9761, 0.490, 0.881}

-- World Events/Darkmoon Faire: Rocketeer: Gold
A{"DarkmoonFaireIsland", 9764, 0.490, 0.881}

-- World Events/Darkmoon Faire: Rocketeer: Silver
A{"DarkmoonFaireIsland", 9766, 0.490, 0.881}

-- World Events/Darkmoon Faire: Rocketeer: Bronze
A{"DarkmoonFaireIsland", 9769, 0.490, 0.881}

-- World Events/Darkmoon Faire: Blast Off!
A{"DarkmoonFaireIsland", 9770, 0.490, 0.881}

-- World Events/Darkmoon Faire: Go-Getter
A{"DarkmoonFaireIsland", 9780, 0.490, 0.881}

-- World Events/Darkmoon Faire: Powermonger: Bronze
A{"DarkmoonFaireIsland", 9781, 0.490, 0.881}

-- World Events/Darkmoon Faire: Powermonger: Silver
A{"DarkmoonFaireIsland", 9783, 0.490, 0.881}

-- World Events/Darkmoon Faire: Powermonger: Gold
A{"DarkmoonFaireIsland", 9785, 0.490, 0.881}

-- World Events/Darkmoon Faire: Wayfarer
A{"DarkmoonFaireIsland", 9786, 0.490, 0.881}

-- World Events/Darkmoon Faire: Wanderluster: Bronze
A{"DarkmoonFaireIsland", 9787, 0.490, 0.881}

-- World Events/Darkmoon Faire: Wanderluster: Silver
A{"DarkmoonFaireIsland", 9790, 0.490, 0.881}

-- World Events/Darkmoon Faire: Wanderluster: Gold
A{"DarkmoonFaireIsland", 9792, 0.490, 0.881}

-- World Events/Darkmoon Faire: Big Race Enthusiast
A{"DarkmoonFaireIsland", 9793, 0.533, 0.878}

-- World Events/Darkmoon Faire: Big Race Novice
A{"DarkmoonFaireIsland", 9794, 0.533, 0.878}

-- World Events/Darkmoon Faire: Big Race Jockey
A{"DarkmoonFaireIsland", 9795, 0.533, 0.878}

-- World Events/Darkmoon Faire: Big Race Leadfoot
A{"DarkmoonFaireIsland", 9797, 0.533, 0.878}

-- World Events/Darkmoon Faire: Big Race Roadhog
A{"DarkmoonFaireIsland", 9799, 0.533, 0.878}

-- World Events/Darkmoon Faire: Rocket Man
A{"DarkmoonFaireIsland", 9800, 0.533, 0.878}

-- World Events/Darkmoon Faire: Big Rocketeer: Bronze
A{"DarkmoonFaireIsland", 9801, 0.533, 0.878}

-- World Events/Darkmoon Faire: Big Rocketeer: Silver
A{"DarkmoonFaireIsland", 9803, 0.533, 0.878}

-- World Events/Darkmoon Faire: Big Rocketeer: Gold
A{"DarkmoonFaireIsland", 9805, 0.533, 0.878}

-- World Events/Darkmoon Faire: Vagabond
A{"DarkmoonFaireIsland", 9806, 0.533, 0.878}

-- World Events/Darkmoon Faire: Big Wanderluster: Bronze
A{"DarkmoonFaireIsland", 9807, 0.533, 0.878}

-- World Events/Darkmoon Faire: Big Wanderluster: Silver
A{"DarkmoonFaireIsland", 9809, 0.533, 0.878}

-- World Events/Darkmoon Faire: Big Wanderluster: Gold
A{"DarkmoonFaireIsland", 9811, 0.533, 0.878}

-- World Events/Darkmoon Faire: Goal-Oriented
A{"DarkmoonFaireIsland", 9812, 0.533, 0.878}

-- World Events/Darkmoon Faire: Big Powermonger: Bronze
A{"DarkmoonFaireIsland", 9813, 0.533, 0.878}

-- World Events/Darkmoon Faire: Big Powermonger: Silver
A{"DarkmoonFaireIsland", 9815, 0.533, 0.878}

-- World Events/Darkmoon Faire: Big Powermonger: Gold
A{"DarkmoonFaireIsland", 9817, 0.533, 0.878}

-- World Events/Darkmoon Faire: Darkmoon Like the Wind
A{"DarkmoonFaireIsland", 9819}

-- World Events/Darkmoon Faire: Ace Tonk Commander
A{"DarkmoonFaireIsland", 9885, 0.506, 0.650}

-- World Events/Darkmoon Faire: Triumphant Turtle Tossing
A{"DarkmoonFaireIsland", 9894, 0.615, 0.778}
