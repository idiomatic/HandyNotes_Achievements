...
L["Show Completed"] = "Показать завершенное"
...
L["Sort by tracked"] = "Сортировать по отслеживаемым"
L["Sort achievements by tracked"] = "Сортировка достижений по отслеживаемым"
